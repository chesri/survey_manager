define([
...
], function (declare, lang, html, query, domStyle, esriRequest, on, topic, dojoDomConstruct, _WidgetsInTemplateMixin, mouse, locale, date, Query, GraphicsLayer, FeatureLayer, SimpleRenderer, Graphic, aspect, WidgetManager, SelectionManager, symbolJsonUtils) {
  return declare("SurveyManager", null, {
    ...
    constructor: function (inMap, inConfig, inAppConfig, parent) {
      ...
      this.parent.own(this.assignmentLayerObj.on("load", lang.hitch(this, this.highlightDaysOnCalendar)));
    ...
    onCalendarFocusChange: function (propName, oldFocus, newFocus) {
      if (this.parent.surveyManagerNeededParameters.node.toggleButton.checked && propName == "currentFocus" && (oldFocus.getFullYear() != newFocus.getFullYear() || oldFocus.getMonth() != newFocus.getMonth())) {
        WidgetManager.getInstance()
          .triggerWidgetOpen(this.attributeTableWidgetId)
          .then(
            lang.hitch(this, function (wdgt) {
        ...
        .then(
          lang.hitch(this, function (wdgt) {
            if (wdgt._activeLayerInfoId == this.surveyonDayLyrId) {
              ...
              this.assignmentLayerObj.selectFeatures(q, FeatureLayer.SELECTION_NEW).then(lang.hitch(this, "openSmartEditWidget"), lang.hitch(this, "queryFailed"));
            }
          })
        );
    },
    ...
    openSmartEditWidget: function (feature) {
      ...
      if (smtWidget && smtWidget.state == "open") {
        ...
        WidgetManager.getInstance()
          .triggerWidgetOpen(this.smartEditWidgetId)
          .then(
            lang.hitch(this, function (smtWidget) {
              smtWidget.beginEditingByFeatures([feature], this.assignmentLayerObj, [this.layerId], [feature]);
            })
          );
      }
    ...
    buildWhereforCurrentMonth: function () {
      ...
      var dateFilter = this.dateField_end + " >= TIMESTAMP '" + beginingDateStr + "' and " + this.dateField_begin + " < TIMESTAMP '" + endingDateStr + "'";
    ...
    queryDatesHavingSurveys: function (layerId) {
      ...
      this.assignmentLayerObj.queryFeatures(calendarQuery, lang.hitch(this, "highlightDaysOnCalendar"), lang.hitch(this, "queryFailed"));
    },
    ...
    query4Features4Date: function (d, callbackFunctionName, event) {
      ...
      var dateFilter = this.dateField_end + " >= TIMESTAMP '" + s_startDate + "' and " + this.dateField_begin + " < TIMESTAMP '" + s_endDate + "'";
      ...
      this.assignmentLayerObj.queryFeatures(calendarQuery, lang.hitch(this, callbackFunctionName, d, calendarQuery.where), lang.hitch(this, "queryFailed"));
    },

define({
  root: ({
    ...
    noVisibleCreateLayerWarning: "Layer(s) not visible at the current zoom level. Select a feature and zoom-to it to modify or zoom in or out to create a feature.",
    noVisibleUpdateLayerWarning:"Layer(s) not visible at the current zoom level. Zoom in or out, or select a feature to modify.",

  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    setConfig: function(_config) {
      ...
      layerInfo.getLayerObject().then(lang.hitch(this, function(layer) {
        ...
        this.layerChooserSelect.setSelectedLayer(layer).then(lang.hitch(this, function(success) {
          ...
          this.dateField_begin.setValue(config.dateField_begin);
          this.dateField_end.setValue(config.dateField_end);
    ...
    getConfig: function(){
      var config = {
        ...
        dateField_begin: this.dateField_begin.getValue(),
        dateField_end: this.dateField_end.getValue()
      };
